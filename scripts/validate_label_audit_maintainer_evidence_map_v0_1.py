...
SOURCE = ROOT / "docs" / "label_audit" / "label_audit_maintainer_evidence_map_v0_1.json"
MARKDOWN = ROOT / "docs" / "label_audit" / "LABEL_AUDIT_MAINTAINER_EVIDENCE_MAP_V0_1.md"

REQUIRED_EVIDENCE_IDS = {"LAME001", "LAME002", "LAME003", "LAME004", "LAME005"}
REQUIRED_SOURCE_READINESS_IDS = {"LAMR001", "LAMR002", "LAMR003", "LAMR004", "LAMR005"}
REQUIRED_FILES = [
...
def main() -> int:
    ...
    if data.get("previous_public_issue_number") != 33:
        errors.append("previous_public_issue_number must be 33")
    ...
    if errors:
        print("FAIL label audit maintainer evidence map validation")
        for error in errors:
            print(f"- {error}")
        return 1

    print("PASS label audit maintainer evidence map validation")
