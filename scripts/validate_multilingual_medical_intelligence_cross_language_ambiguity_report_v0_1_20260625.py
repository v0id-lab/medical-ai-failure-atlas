...
from score_multilingual_medical_intelligence_cross_language_ambiguity_controls_v0_1_20260625 import (
...
def main() -> int:
    ...
    if errors:
        print("FAIL cross language ambiguity report validation")
        for error in errors:
            print(f"- {error}")
        return 1
    ...
    try:
        ...
        print(f"FAIL cross language ambiguity report validation: {error}")
        return 1
    ...
    print("PASS cross language ambiguity report validation")
