...
from score_multilingual_medical_intelligence_cross_language_reviewer_closeout_ledger_reconciliation_controls_v0_1_20260625 import (
...
def main() -> int:
    ...
    if errors:
        print("FAIL cross language reviewer closeout ledger reconciliation report validation")
        for error in errors:
            print(f"- {error}")
        return 1
    ...
    try:
        ...
        print(f"FAIL cross language reviewer closeout ledger reconciliation report validation: {error}")
        return 1
    ...
    print("PASS cross language reviewer closeout ledger reconciliation report validation")
