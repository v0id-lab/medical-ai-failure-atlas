...
from score_mmi_072_archive_reuse_release_handoff_closure_archive_reuse_controls_v0_1_20260625 import (
...
def main() -> int:
    ...
    if errors:
        print("FAIL archive reuse release handoff closure archive reuse report validation")
        for error in errors:
            print(f"- {error}")
        return 1
    try:
        ...
        print(f"FAIL archive reuse release handoff closure archive reuse report validation: {error}")
        return 1
    ...
    if errors:
        ...
        for error in errors:
            print(f"- {error}")
        return 1
    print("PASS archive reuse release handoff closure archive reuse report validation")
