...
from score_mmi_186_chain_archive_controls_v0_1_20260625 import (
...
def main() -> int:
    ...
    if errors:
        print(f"FAIL {REPORT_LABEL} report validation")
        for error in errors:
            print(f"- {error}")
        return 1
    try:
        ...
        print(f"FAIL {REPORT_LABEL} report validation: {error}")
        return 1
    ...
    if errors:
        ...
        for error in errors:
            print(f"- {error}")
        return 1
    print(f"PASS {REPORT_LABEL} report validation")
