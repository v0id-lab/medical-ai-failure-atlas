...
REQUIRED_PHRASES = [
    ...
    "maps thirteen atlas nodes to local runtime artifacts",
    ...
    "checks passing rows, expected fail drift controls, drift signal counts, failure reason counts, reviewer triage, rewrite candidate scoring, blocked candidate counts, cross language ambiguity controls, cross language negation audience controls, and translation clearance absence without score certification",
    "multilingual paired state source checks, public wording bank checks, drift negative controls, public wording drift score report, rewrite candidate score report, cross language ambiguity report, cross language negation audience report, and exact next action state",
