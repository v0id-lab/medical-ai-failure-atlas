...
REQUIRED_PHRASES = [
    ...
    "checks passing rows, expected fail drift controls, drift signal counts, failure reason counts, and reviewer triage without score certification",
    "multilingual paired state source checks, public wording bank checks, drift negative controls, public wording drift score report, and exact next action state",
