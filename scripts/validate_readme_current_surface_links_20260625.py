...
REQUIRED_PHRASES = [
    ...
    "checks passing rows, expected fail drift controls, drift signal counts, failure reason counts, reviewer triage, rewrite candidate scoring, and blocked candidate counts without score certification",
    "multilingual paired state source checks, public wording bank checks, drift negative controls, public wording drift score report, rewrite candidate score report, and exact next action state",
