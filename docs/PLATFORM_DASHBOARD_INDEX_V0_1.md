...
87. 3 Türkiye AI ethics status source rows.
88. 6 Türkiye AI ethics status gate rows.
...
95. [Türkiye AI ethics status gate note](TURKIYE_AI_ETHICS_STATUS_GATE_NOTE_V0_1.md)
96. [Türkiye AI ethics status gate note JSON](turkiye_ai_ethics_status_gate_note_v0_1.json)
