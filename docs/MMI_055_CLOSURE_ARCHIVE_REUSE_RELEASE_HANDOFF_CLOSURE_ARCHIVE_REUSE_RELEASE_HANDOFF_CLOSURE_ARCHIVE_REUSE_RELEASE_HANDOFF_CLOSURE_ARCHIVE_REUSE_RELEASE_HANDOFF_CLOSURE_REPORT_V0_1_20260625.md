...
5. `unresolved_branch_closure_boundary_exception_replay_archive_rollup_release_handoff_closure_archive_reuse_release_handoff_closure_archive_reuse_release_handoff_closure_archive_reuse_release_lost`: declared 1, detected 1.
...
Can closed closure archive reuse release handoff closure archive reuse release handoff closure archive reuse packets stay archive reopenable before downstream closure review without authority or clearance claim.
...
5. `unresolved_branch_closure_boundary_exception_replay_archive_rollup_release_handoff_closure_archive_reuse_release_handoff_closure_archive_reuse_release_handoff_closure_archive_reuse_release_lost`
