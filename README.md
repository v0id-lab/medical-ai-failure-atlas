...
22. [Medical Intelligence Atlas Coverage Dashboard](docs/medical_intelligence_atlas_coverage_dashboard.md): machine readable coverage dashboard that maps eighteen atlas nodes to local runtime artifacts, validators, coverage focus, and open gap state.
